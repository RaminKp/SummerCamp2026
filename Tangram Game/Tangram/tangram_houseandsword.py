...
def run_level(qt, camera_index=1, show_camera=False, llm_feedback=False,
    ...
    def configure_for_shape(sid) -> bool:
        ...
        nonlocal warned, timed_out, last_activity, inactivity_nudged
        cfg = SHAPES[sid]
        ...
        last_activity = time.time()
        inactivity_nudged = False
        print(f"[Game] Now playing: {cfg['title']}")
        return True
    ...
    try:
        ...
        while True:
            ...
            # completion -> celebrate, then reset so they can rebuild or swap boards
...
def main():
    ...
    p.add_argument("--timer", type=float, default=0.0,
                   help="Countdown seconds (0=off; ages 9-12 default off). "
